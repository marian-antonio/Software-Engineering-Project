...
<head>
    ...
    <title>Admin - Maintain Reviewers</title>
</head>
        ...
        <main>
            ...
            <div class="reports-container">
                ...
                <?php 
                    ...
                    include_once ("maintainReviewerProcess.php");
                        ...
                        <table>
                            ...
                            <tr>
                                <td style="word-spacing: 5px; text-align: center;">
                                    ...
                                    <a href="maintainReviewerProcess.php?delete=<?php echo $row['ReviewerID']; ?>"><i
                        ...
                        <div class="modal fade" id="ReviewerModalAdd" tabindex="-1" role="dialog"
                            ...
                            <div class="modal-dialog modal-lg" role="document">
                                <div class="modal-content">
                                    ...
                                    <form action="maintainReviewerProcess.php" method="post">
                                                ...
                                                <div class="topics">
                                                    <table>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td><label for="analysisOfAlgorithms"
                                                                    class="checkbox">Analysis
                                                                    of
                                                                    Algorithms</label></td>
                                                        ...
                                                        <tr>
                                                            <td>
                                                                <input type="hidden" id="applicationsHidden"
                                                            ...
                                                            <td>
                                                                <input type="hidden" id="genderIssuesHidden"
                                                                    name="genderIssues" value='0'>
                                                                <input type="checkbox" id="genderIssues"
                                                                    name="genderIssues" value='1'>
                                                            </td>
                                                        ...
                                                        <tr>
                                                            <td>
                                                                <input type="hidden" id="architectureHidden"
                                                            ...
                                                            <td>
                                                                <input type="hidden" id="grantWritingHidden"
                                                                    name="grantWriting" value='0'>
                                                                <input type="checkbox" id="grantWriting"
                                                                    name="grantWriting" value='1'>
                                                            </td>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <input type="hidden" id="pedagogyHidden" name="pedagogy"
                                                                    value='0'>
                                                                <input type="checkbox" id="pedagogy" name="pedagogy"
                                                                    value='1'>
                                                            </td>
                                                        ...
                                                        <tr>
                                                            <td>
                                                                <input type="hidden" id="curriculumHidden"
                                                                    name="curriculum" value='0'>
                                                        ...
                                                        <tr>
                                                            <td>
                                                                ...
                                                                <input type="checkbox" id="dataStructures"
                                                                    name="dataStructures" value='1'>
                                                            </td>
                                                            ...
                                                            <td>
                                                                <input type="hidden" id="literacyHidden" name="literacy"
                                                                    value='0'>
                                                                <input type="checkbox" id="literacy" name="literacy"
                                                                    value='1'>
                                                            </td>
                                                        ...
                                                        <tr>
                                                            <td>
                                                                <input type="hidden" id="databasesHidden"
                                                                    name="databases" value='0'>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <input type="hidden" id="multimediaHidden"
                                                                    name="multimedia" value='0'>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <input type="hidden"
                                                                    id="networkDataCommunicationsHidden"
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                ...
                                                                <input type="checkbox" id="webProgramming"
                                                                    name="webProgramming" value='1'>
                                                            </td>
                                                        ...
                                                        <tr>
                                                            <td>
                                                                <input type="hidden" id="otherHidden" name="other"
                                                                    value='0'>
